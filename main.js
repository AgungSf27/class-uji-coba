...
toggle.addEventListener('click', function() {
  ...
  if (this.classList.toggle('bi-moon')) {
    ...
    box5.style.filter = 'invert(0)';
    box6.style.filter = 'invert(0)';
    box7.style.filter = 'invert(0)';
    box8.style.filter = 'invert(0)';
    ...
    box5.style.filter = 'invert()';
    box6.style.filter = 'invert()';
    box7.style.filter = 'invert()';
    box8.style.filter = 'invert()';
